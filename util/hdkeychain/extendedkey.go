...
//}
////
////func BipKeyToExtendedKey(k bip32.Key)  *ExtendedKey {
////	return &ExtendedKey{
////		key:       k.Key,
...
//func (k *ExtendedKey) Address(net *chaincfg.Params) (*address.PubKeyHashAddress, error) {
//	pkHash := chainhash.Hash160(k.pubKeyBytes())
//	return address.NewPubKeyHashAddressByNetId(pkHash, net.PubKeyHashAddrID)
//}
//
