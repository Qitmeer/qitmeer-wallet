...
func Dial(URL, user, pass string, certs string) (*Client, error) {
	if u, err := url.Parse(URL); err == nil {
		switch u.Scheme {
		case "http":
			return dailHTTP(URL, user, pass, true, certs)
		case "https":
			return dailHTTP(URL, user, pass, false, certs)
		case "ws", "wss":
			//TODO websocket
...
func dailHTTP(URL string, user, pass string, notls bool, certs string) (*Client, error) {
